...
import { HomePagePlant } from "@/components/HomePagePlant";
      ...
      {session ? (
        <>
          <p className="mt-4 max-w-2xl text-lg text-foreground/80">
            Welcome back. Your wellness journey continues here.
          </p>
          <div className="mt-10">
            <HomePagePlant />
          </div>
          <Link
            href="/dashboard"
            className="mt-8 inline-block rounded-md bg-primary px-6 py-3 text-base font-medium text-white transition-colors hover:bg-primary/90"
          >
            Go to Dashboard
          </Link>
        </>
